...
Download embeddings and LLM models:
...
POST /ask — Send a question JSON { "message": "<your question>" }
GET /health — Check if the chatbot is initialized

Project Structure
backend/
├─ app.py # Flask API
├─ ai_service.py # RAG chatbot class
├─ data/
│ └─ abu_dataset.csv # Knowledge base CSV
